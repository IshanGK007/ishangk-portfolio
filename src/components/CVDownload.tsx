...
const CVDownload = () => {
  return (
    <section id="cv" className="py-20 bg-slate-50 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Card className="p-6 card-hover bg-white border border-slate-200 w-full max-w-md">
            <div className="flex flex-col items-center space-y-4">
              ...
              <a
                href="/path-to-your-cv.pdf" // Add your CV file path here
                download
